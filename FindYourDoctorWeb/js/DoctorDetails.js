function populateDoctorDetails(physicianId) {
	...
	$.ajax({
		...
		success : function(responseText) {
			...
			$("#name").text(result.lastName+','+result.firstName+' '+result.middleInitial);
			
			var address = result.location.street + ' '+result.location.suiteNumber + ' ';
			address += '<br/>'+ result.location.city+' '+ result.location.state+' '+result.location.zipCode;
